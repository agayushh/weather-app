     ...
     <div className="bg-[#0b131e] h-[120vh] w-full">
      <div className="flex">
       <Navbar />
        ...
        <div className="h-23 mt-3 w-[49vw] bg-[#202b3b] ml-12 rounded-2xl "> Notifications</div>
        <div className="text-lg text-white ml-16 mt-4 font-bold">
          General
          
        </div>
        <div className="h-48 mt-3 w-[49vw] bg-[#202b3b] ml-12 rounded-2xl "> Notifications</div>
        </div>  
      </div>
    </div>
  </div>;
